...
router.post('/api/promo/product/', Upload.single('image'), PromoController.createPromo)
router.put('/api/promo/product/:id', Upload.single('image'), PromoController.updatePromo)
